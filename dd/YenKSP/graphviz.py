...
class Graphviz:
    ...
    _root_dir = "/Users/w17626/dd/YenKSP"
    _directory_data = "%s/data/dot/" % _root_dir
    ## The location that the graph data is stored as images.
    _directory_images = "%s/images/" % _root_dir
    ## The location of the templates for the dot markup.
    _directory_templates = "%s/data/templates/" % _root_dir
